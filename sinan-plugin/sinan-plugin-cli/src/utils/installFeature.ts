...
export function installESLint(): void {
  ...
  `;
  try {
    fs.writeFileSync('./.eslintrc.js', eslintrc, { encoding: 'utf-8' });
  } catch (err) {
...
export function installPrettier(): void {
  ...
  `;
  try {
    fs.writeFileSync('./.prettierrc.js', prettierrc, { encoding: 'utf-8' });
  } catch (err) {
...
export function installCZ(): void {
  ...
  `;
  try {
    fs.writeFileSync('./commitlint.config.js', commitlint, {
      encoding: 'utf-8',
    });
  } catch (err) {
    printMsg(
